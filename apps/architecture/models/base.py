...
from common.constants import ZABBIX_STATUS
...
class Base(BaseModel):
    ...
    status = models.CharField(max_length=255, blank=True, null=True, verbose_name='zabbix状态', default=2, choices=ZABBIX_STATUS)
